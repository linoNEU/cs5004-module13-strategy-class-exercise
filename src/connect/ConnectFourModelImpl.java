 ...
 * handling player moves, and checking for win/draw conditions. It also uses different strategies to
 * play the game (Yellow player).
 */
public class ConnectFourModelImpl implements ConnectFourModel {
  ...
  public ConnectFourModelImpl(int rows, int columns) throws IllegalArgumentException {
    ...
    this.strategy = new RandomGameStrategy();
    initializeBoard();
  }
  ...
  @Override public void setStrategy(GameStrategy strategy) {
